...
export default function UserDataDeleteConfirmModal({modalIsOpen, modalHandler, deleteType, deleteHandler}: props) {
  return (
    <div>
      <Modal
        open={modalIsOpen}
        ...
        aria-describedby={`本当に${deleteType}を削除してもよろしいですか？`}
      >
        <Box sx={style.window}>
          <p css={style.info}>本当に{deleteType}を削除してもよろしいですか？</p>
          ...
          <Box display="flex" justifyContent="flex-end" marginTop="10px">
            ...
            <Button css={style.button_delete} onClick={() => deleteHandler()} variant="contained">{deleteType}を削除</Button>
          </Box>
        </Box>
      </Modal>
    </div>
